...
using SeaInk.Core.StudyTable.Exceptions;
...
namespace SeaInk.Core.StudyTable
{
    public class StudentAssignmentProgressTableDifference
    {
        ...
        public StudentAssignmentProgressTableDifference(
            ...
            IReadOnlyCollection<Assignment> removedAssignments,
            IReadOnlyCollection<Assignment> addedAssignments,
            IReadOnlyCollection<StudentAssignmentProgressDifference> assignmentProgressDifferences)
        {
            ...
            if (removedAssignments.Intersect(addedAssignments).Any())
                throw new AddRemoveDifferenceIntersectException<Assignment>();
        ...
        public IReadOnlyCollection<Assignment> RemovedAssignments { get; }
        public IReadOnlyCollection<Assignment> AddedAssignments { get; }
